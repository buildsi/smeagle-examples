...
abi_typelocation("example","_Z3fooiP12StructyChildP13StructyParent","Import","Integer8","((%rsi)+16+16)").
...
abi_typelocation("example","_Z3fooiP12StructyChildP13StructyParent","Import","Integer8","(((%rdx))+16+16)").
